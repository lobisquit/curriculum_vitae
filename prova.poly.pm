...
◊CVsection[#:title "Education"]{
  ◊CVobject[#:period "2013--2016"]{Bachelor at Padova University}
  ◊CVitems{
    ◊CVitem{Degree ◊sl{summa cum laude} on Information Engineering, GPA 29.379/30}
  ...
  ◊CVobject[#:period "2016--2018"]{Relevant master courses}
  ◊CVitems{
    ◊CVitem[
...
◊CVobject[#:period "2015"]{Internship at Padova Hospital}
◊CVitems{
...
◊CVobject[#:period "2008--2018"]{Seasonal work in local vineyards}
}
